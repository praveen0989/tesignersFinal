...
urlpatterns = patterns('',
    ...
    url(r'^login/$', 'tesigners.views.index', name='login'),
    ...
    url(r'^validate_session/$', 'tesigners.views.validate_session', name='validate_session'),
    ...
    url(r'^downloadTemplate/$', 'tesigners.views.download_template', name='download_template')
